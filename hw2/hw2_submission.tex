...
\begin{answer}[title=Q5.2.3,height=10cm,width=\linewidth]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.99\linewidth]{figs/Q5.2.3.png}
        \caption{Reaches maximum reward (1000) as early as 40 iterations.}
    \end{figure}
\end{answer}
...
\begin{answer}[title=Q7.2.2,height=10cm,width=\linewidth]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.99\linewidth]{figs/Q7.2.2.png}
        \caption{Looks like reward-to-go significantly boosts the performance.}
    \end{figure}
\end{answer}
...
\begin{answer}[title=Q7.2.4,height=10cm,width=\linewidth]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.99\linewidth]{figs/Q7.2.4.png}
        \caption{Exhaustive search for optimal b* and r* in $b \in \{10000, 30000, 50000\}$ and $r \in \{0.005, 0.01, 0.02\}$}
    \end{figure}
\end{answer}
